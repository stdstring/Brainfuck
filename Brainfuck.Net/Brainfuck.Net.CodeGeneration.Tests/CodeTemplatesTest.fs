...
type CodeTemplatesTest() =
    ...
    member public this.BaseCtor() =
        let assemblyBuilder : AssemblyBuilder = AssemblyBuilder.DefineDynamicAssembly(new AssemblyName(Name = "TestAssembly"), AssemblyBuilderAccess.Run)
    ...
    member public this.ChangeValueWithLocalVariable() =
        ...
        generator.EmitCall(OpCodes.Callvirt, someValueGetter, null)
        ...
        generator.EmitCall(OpCodes.Callvirt, someValueSetter, null)
        generator.Emit(OpCodes.Ret)
